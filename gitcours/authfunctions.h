...
void adminmenu() {
    ...
    cout << "6. Почта" << endl;
    cout << "7. Управление балансом пользователей " << endl;
    cout << "8. Промокоды" << endl;
    cout << "9. Выйти из приложения" << endl;
    ...
    if (a == 7) {
        ...
        int b = 1;
        ifstream file("userdb.txt");
        cout << "Список пользователей, которым можно изменить баланс: " << endl;
        if (file.is_open()) {
            string line;
            while (std::getline(file, line)) {
                istringstream iss(line);
        ...
        int num;
        cout << "Введите номер пользвоателя, которому хотите изменить баланс" << endl;
        cin >> num;
        int sum;
        cout << "Введите новый балас пользователя: " << endl;
        cin >> sum;
        UserMas[num - 1].balance = sum;
        ofstream userdata;
        ...
        userdata.close();
        system("cls");
        cout << "Баланс успешно обновлён" << endl;
        adminmenu();
